    ...
    methods:{
        ...
        async collectionClick() {
           if(localStorage.getItem('token')){
               const res = await this.$http.post('/like/article' + localStorage.getItem('id'),{article_id:this.$route.params.id})
        ...
        async collectionInit() {
            if(localStorage.getItem('token')){
                const res = await this.$http.get('/like/article' + localStorage.getItem('id'),{
                    params:{
